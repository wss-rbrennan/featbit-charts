...
func TestUiServiceTemplateRenderedDeployment(t *testing.T) {
	t.Parallel()
	...
	output := helm.RenderTemplate(t, options, helmChartPath, releaseName, []string{"templates/ui-service.yaml"})
	...
	require.Equal(t, "featbit-ui", service.Name)
